function r = BussSRTellDoneFunc(r,pos,message)
%function r = BussSRTellDoneFunc(r,pos,message)
%
...
%
% This function, BussSRTellDoneFunc, sets up the response window 
% with a a "Testing Complete" message
%
% use message to give a custom message
...
%% create the figure  
IDString = sprintf('BussSR: %s','ALL DONE'); % note Emily's had SNR and trial number in response GUI also
